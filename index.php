...
<body>
    ...
    <? if (empty($signature)) { ?>
      <header class="search_wrapper">
        ...
        <div id="results">
          ...
          <button id="show-favorites" class="hidden">Favoris</button>
        </div>
        ...
        foreach ($poemes as $i => $poeme) {
          ...
          if ($validSignature && $validHasMasqué) {
            ...
            <div class="poeme visible" data-id="<?= $i ?>">
              ...
              <div class="action-button js-image-button">
  ...
  <div id="modal" class="modal">
    <div class="modal-content">
      ...
      <ul>
        <li><code>rime:mot1:mot2</code> : recherche par couple de rimes</li>
        <li><code>#thème</code> : recherche exacte de thème</li>
        <li><code>"texte exact"</code> : recherche exacte</li>
        <li><code>123-456</code> : poèmes de 123 à 456</li>
        <li><code>2025-01-01-</code> : poèmes depuis cette date</li>
      </ul>
    </div>
  </div>
